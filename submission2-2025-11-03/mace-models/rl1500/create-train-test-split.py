...
train_500K_500indices = np.load('/scratch/cganley2/mlip/Maximize_Diversity_using_RL_Dataset/Diverse_Subset_from_500K/top_indices_rl_500K_500.npy')
train_1500K_500indices = np.load('/scratch/cganley2/mlip/Maximize_Diversity_using_RL_Dataset/Diverse_Subset_from_1500K/top_indices_rl_1500K_500.npy')
train_2500K_500indices = np.load('/scratch/cganley2/mlip/Maximize_Diversity_using_RL_Dataset/Diverse_Subset_from_2500K/top_indices_rl_2500K_500.npy')
...
ase.io.write('rl-train1500.extxyz', training_1500)
ase.io.write('rl-test13500.extxyz', test_13500)