...
# 2025-10-08 I EDITED THIS INCORRECTLY AND NOW IT'S OVERWRITTEN IN THE SAVE FILE
train_set_path = '/scratch/cganley2/mlip/Maximize_Diversity_using_RL_Dataset/train-set-227.extxyz'
valid_set_path = '/scratch/cganley2/mlip/Maximize_Diversity_using_RL_Dataset/validation-set-24.extxyz'
test_set_path = '/scratch/cganley2/mlip/Maximize_Diversity_using_RL_Dataset/test-set-49.extxyz'
epochs = 60
